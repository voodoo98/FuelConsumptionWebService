...
@AutoValue
public abstract class FuelByGasStation {

	@JsonCreator
	public static Builder builder() {
		return new AutoValue_FuelByGasStation.Builder();
	}
	...
	public abstract static class Builder {
		...
		public abstract Builder carPlate(String carPlate);

		public abstract Builder date(Date date);

		public abstract FuelByGasStation build();
	}
